		...
		*/
		...
		public static function sa_load_all_str() {
			self::$sm_deactivation_string = array(
				...
				'deactivation-modal-button-deactivate'     => __( 'Deactivate', 'smart-manager-for-wp-e-commerce' ),
				'deactivation-modal-button-cancel'         => __( 'Cancel', 'smart-manager-for-wp-e-commerce' ),
