...
if ( function_exists( 'smart_manager_get_data' ) ) {
	...
	$sa_plugin_version = $plugin_data['Version'];
} else {
	$sa_plugin_version = '';
}
	...
	( function ($) {
		...
		var reasonsHtml = <?php echo json_encode( $reasons_list_items_html ); ?>,
			modalHtml =
				...
				+ '         <a href="#" class="button button-primary button-close"><?php printf( SA_Smart_Manager_Deactivation::load_str( 'deactivation-modal-button-cancel' ) ); ?></a>'
				+ '     </div>'
				+ ' </div>'
				+ '</div>',
			$modal = $(modalHtml),
