...
class Smart_Manager_Admin_Welcome {
	...
	function smart_manager_support_ticket_content() {
		...
		StoreApps_Upgrade_3_3::support_ticket_content( self::$prefix, self::$sku, $plugin_data, $license_key, 'smart-manager-for-wp-e-commerce' );
	}
			...
			<div class="column col last-feature">
				<p align="right">
					...
					<?php if ( SMBETAPRO === true ) { ?>
						<a class="button-primary" href="options-general.php?page=smart-manager-settings" target="_blank"><?php _e( 'Settings', 'smart-manager-for-wp-e-commerce' ); ?></a>
					<?php } ?>
